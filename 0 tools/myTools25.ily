...
Prefix = \markup {
  ...
  %\serif C
  %\combine \serif C \translate #'(0.65 . -0.25) \override #'(thickness . 1.2) \draw-line #'(0 . 1.8)
  %\serif B
  \sans B
  %\combine \serif B \translate #'(0.65 . -0.25) \override #'(thickness . 1.2) \draw-line #'(0 . 1.8)
  %%%%%%%%%%%%
  \hspace #0.2
}
barre =
...
GFourDown = \markup \concat { \hspace #-1 \raise #.4 \rotate #-15 "–" \number "4" }
...
GOne 	= \markup \concat { \hspace #-.7 "–" \hspace #.3 \number  "1" }
GTwo 	= \markup \concat { \hspace #-.7 "–" \hspace #.3 \number  "2" }
GThree = \markup \concat { \hspace #-.7 "–" \hspace #.3 \number  "3" }
GFour	= \markup \concat { \hspace #-.7 "–" \hspace #.3 \number "4" }
glissOne =
...
Applying conversion: 2.25.0, 2.25.1, 2.25.3, 2.25.4, 2.25.5,  Not
smart enough to convert advanced use of (text-)font-defaults.  The
text-font-defaults and font-defaults variables have been merged into a
single property-defaults variable. Please refer to the manual for
details, and update manually. 2.25.6, 2.25.8, 2.25.9
%}
