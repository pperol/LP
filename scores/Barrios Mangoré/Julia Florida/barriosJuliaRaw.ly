...
voixUn = {
  ...
  | % mes.7
    g'4. fis'8 e' g'
  | % mes.8
    fis'4. b8\glissando cis'\glissando d'
  | % mes.9
    e'4. 8 fis' d' \glissando
  | % mes.10
    \slashedGrace e'8 8 b\glissando d' cis' b a\harmonic
  | % mes.11
    \slashedGrace fis8 \glissando a4. 8 b a
  | % mes.12
    a4. 8 b cis'
...
codaVoixUn = {
    ...
    | % mes.59
      \stemNeutral
      d'8\harmonic fis'\harmonic a'\harmonic d''\harmonic fis''\harmonic a''\harmonic
    | % mes.60
      \har <d'''>4. \har<fis' a' d''>\pp
    | % mes.61
...
\header {
  ...
  %piece = \markup\italic\fontsize #-1 { La \concat { 6 \teeny\raise #.6 a } corda en Ré. }
  dedication = \markup
